...
document.addEventListener("DOMContentLoaded", () => {
  document
    .getElementById("simularInversionButton")
    .addEventListener("click", simularInversion);
});
document.addEventListener("DOMContentLoaded", () => {
  document
    .getElementById("simularInversion2Button")
    .addEventListener("click", simularInversion2);
});
